...
productGrids = document.querySelector('.js-products-grid');
productGrids.innerHTML = productsHTML;
add_to_cart_buttons = document.querySelectorAll('.js-add-to-cart-button');
